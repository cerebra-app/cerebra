...
function WriteEntry({ entry, onSave, onDelete, onBack }) {
  ...
  return (
    <div className="full-height flex flex-col bg-surfacedark:bg-slate-900 overflow-hidden page-enter">
      {/* Header */}
...
export default function Journal() {
  ...
  // ── List screen ──
  return (
    <div className="full-height overflow-hidden bg-surfacedark:bg-slate-900 page-enter">
      {/* Header */}
